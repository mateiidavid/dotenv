...
function M.lsp_bindings(bufnr)
    ...
    local buf_keys = {
        ...
        { mode = 'n', lhs = 'gh', rhs = "<cmd>lua require('lspsaga.provider').lsp_finder()<CR>", opts = opts },
        { mode = 'n', lhs = 'gD', rhs = "<cmd>lua require('lspsaga.provider').preview_definition()<CR>", opts = opts },
        { mode = 'n', lhs = 'K', rhs = '<cmd>lua vim.lsp.buf.hover()<CR>', opts = opts },
        { mode = 'n', lhs = 'gi', rhs = '<cmd>lua vim.lsp.buf.implementation()<CR>', opts = opts },
        { mode = 'n', lhs = 'gs', rhs = "<cmd>lua require('lspsaga.signaturehelp').signature_help()<CR>", opts = opts },
        ...
        { mode = 'n', lhs = '<space>wa', rhs = '<cmd>lua vim.lsp.buf.add_workspace_folder()<CR>', opts = opts },
        { mode = 'n', lhs = '<space>wr', rhs = '<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>', opts = opts },
        {
            mode = 'n',
            lhs = '<space>wl',
        ...
        { mode = 'n', lhs = '<space>D', rhs = '<cmd>lua vim.lsp.buf.type_definition()<CR>', opts = opts },
        ...
        { mode = 'n', lhs = '<space>q', rhs = '<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>', opts = opts },
        { mode = 'n', lhs = '<space>f', rhs = '<cmd>lua vim.lsp.buf.formatting()<CR>', opts = opts },
        { mode = 'n', lhs = '<space>l', rhs = "<cmd>lua require('lsp_lines').toggle()<CR>", opts = opts },
    }
